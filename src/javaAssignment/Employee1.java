...
class YoungAgeEmployee implements Comparator<Employee1>{
...
class TestEmployee12 {
    public static void main(String[] args) {
      ...
      //************** get the details of youngest male employee in the product development department************
        int YoungMaleEmp=0;
        Collections.sort(emplist,new YoungAgeEmployee());
        for(Employee1 emp:emplist){
            if(emp.gender=="Male" && emp.department =="Product Development"){
